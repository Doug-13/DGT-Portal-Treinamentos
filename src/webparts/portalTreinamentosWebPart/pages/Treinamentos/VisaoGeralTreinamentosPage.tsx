      ...
      <section>
        ...
        <div
          style={{
            ...
            gridTemplateColumns:
              'minmax(0,2.1fr) minmax(280px,.9fr)',
                    ...
                    >
                      {
                        meusTreinamentos.map(
                          item => (
                            <TreinamentoCard
                              key={
                                `${item.id}-${item.usuarioTreinamentoId || ''}`
                              }
                              treinamento={
                                item
                              }
